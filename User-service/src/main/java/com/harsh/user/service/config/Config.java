package com.harsh.user.service.config;
...
import com.harsh.user.service.config.interceptor.RestTemplateInterceptor;
...
public class Config {
	...
	public RestTemplate restTemplate() {
		...
		return restTemplate;
		//return new RestTemplate(); // commented to implement interceptors on restTemplate;
	}
